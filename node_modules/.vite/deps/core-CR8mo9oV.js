...
function asRoughMs(dur) {
	return dur.years * 31536e6 + dur.months * 2592e6 + dur.days * 864e5 + dur.milliseconds;
}
...
function diffDays(m0, m1) {
	return (m1.valueOf() - m0.valueOf()) / 864e5;
}
function diffHours(m0, m1) {
	return (m1.valueOf() - m0.valueOf()) / 36e5;
}
function diffMinutes(m0, m1) {
	return (m1.valueOf() - m0.valueOf()) / 6e4;
}
...
function expandRanges(daysOfWeek, startTime, eventDateEnv, calendarDateEnv, framingRange) {
	...
	if (startTime) {
		...
		else if (startTime.milliseconds >= 864e5) dayMarker = addDays(dayMarker, -1);
	}
...
var version = "6.1.21";
//#endregion
export { buildEventApis as $, isMultiDayRange as $t, RefMap as A, getElSeg as At, WeekNumberContainer as B, groupIntersectingEntries as Bt, EventImpl as C, d as Cn, formatDayString as Ct, NowIndicatorContainer as D, getDateMeta as Dt, MoreLinkContainer as E, getClippingParents as Et, Slicer as F, getSegAnchorAttrs as Ft, addWeeks as G, interactionSettingsStore as Gt, addDays as H, hasCustomDayCellContent as Ht, Splitter as I, getSegMeta as It, applyMutationToEventStore as J, intersectRects as Jt, allowContextMenu as K, interactionSettingsToStore as Kt, StandardEvent as L, getStickyFooterScrollbar as Lt, Scroller as M, getEventTargetViaRoot as Mt, SegHierarchy as N, getRectCenter as Nt, NowTimer as O, getDayClassNames as Ot, SimpleScrollGrid as P, getRelevantEvents as Pt, buildEntryKey as Q, isInteractionValid as Qt, ViewContainer as R, getStickyHeaderDates as Rt, EventContainer as S, _ as Sn, eventTupleToStore as St, JsonRequestError as T, formatIsoTimeString as Tt, addDurations as U, identity as Ut, WindowScrollController as V, hasBgRendering as Vt, addMs as W, injectStyles as Wt, asRoughMs as X, isDateSelectionValid as Xt, applyStyle as Y, intersectSpans as Yt, binarySearch as Z, isDateSpansEqual as Zt, DaySeriesModel as _, sortEventSegs as _n, diffWeeks as _t, globalLocales as a, parseEventDef as an, computeEarliestSegStart as at, ElementScrollController as b, whenTransitionDone as bn, elementMatches as bt, version as c, preventSelection as cn, config as ct, BgEvent as d, refineEventDef as dn, createEmptyEventStore as dt, isPropsEqual as en, buildEventRangeKey as et, ContentContainer as f, removeElement as fn, createEventInstance as ft, DayHeader as g, sliceEventStore as gn, diffPoints as gt, DayCellContainer as h, setRef as hn, diffDays as ht, formatRange as i, parseDragMeta as in, compareNumbers as it, ScrollController as j, getEntrySpanEnd as jt, PositionCache as k, getDefaultEventEnd as kt, BASE_OPTION_DEFAULTS as l, rangeContainsMarker as ln, constrainPoint as lt, DateProfileGenerator as m, renderScrollShim as mn, diffDates as mt, createPlugin as n, memoize as nn, buildNavLinkAttrs as nt, globalPlugins as o, pointInsideRect as on, computeInnerRect as ot, DateComponent as p, renderFill as pn, createFormatter as pt, allowSelection as q, intersectRanges as qt, formatDate as r, multiplyDuration as rn, buildSegTimeText as rt, sliceEvents as s, preventContextMenu as sn, computeRect as st, Calendar as t, mapHash as tn, buildIsoString as tt, BaseComponent as u, rangeContainsRange as un, createDuration as ut, DayTableModel as v, startOfDay as vn, disableCursor as vt, Interaction as w, y as wn, formatIsoMonthStr as wt, Emitter as x, wholeDivideDurations as xn, enableCursor as xt, ElementDragging as y, triggerDateSelect as yn, elementClosest as yt, ViewContextType as z, getUniqueDomId as zt };
