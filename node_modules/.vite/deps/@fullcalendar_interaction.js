import { $ as buildEventApis, At as getElSeg, C as EventImpl, Et as getClippingParents, Gt as interactionSettingsStore, J as applyMutationToEventStore, Jt as intersectRects, K as allowContextMenu, Kt as interactionSettingsToStore, Mt as getEventTargetViaRoot, Nt as getRectCenter, Pt as getRelevantEvents, Qt as isInteractionValid, St as eventTupleToStore, Ut as identity, V as WindowScrollController, Xt as isDateSelectionValid, Y as applyStyle, Zt as isDateSpansEqual, an as parseEventDef, b as ElementScrollController, bn as whenTransitionDone, bt as elementMatches, cn as preventSelection, ct as config, dn as refineEventDef, dt as createEmptyEventStore, fn as removeElement, ft as createEventInstance, gt as diffPoints, in as parseDragMeta, it as compareNumbers, j as ScrollController, kt as getDefaultEventEnd, l as BASE_OPTION_DEFAULTS, lt as constrainPoint, mt as diffDates, n as createPlugin, on as pointInsideRect, ot as computeInnerRect, q as allowSelection, sn as preventContextMenu, st as computeRect, tn as mapHash, un as rangeContainsRange, ut as createDuration, vn as startOfDay, vt as disableCursor, w as Interaction, x as Emitter, xt as enableCursor, y as ElementDragging, yn as triggerDateSelect, yt as elementClosest } from "./core-CR8mo9oV.js";
import "./internal-B8nNMQvC.js";
	...
	handleSide(edge, seconds) {
		...
		switch (edge.name) {
			...
			case "right":
				...
				break;
			case "top": sign = -1;
			case "bottom": scrollCache.setScrollTop(scrollCache.getScrollTop() + velocity * sign);
		}
	}
