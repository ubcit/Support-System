import { A as RefMap, B as WeekNumberContainer, Bt as groupIntersectingEntries, Cn as d, D as NowIndicatorContainer, E as MoreLinkContainer, F as Slicer, Ht as hasCustomDayCellContent, I as Splitter, It as getSegMeta, L as StandardEvent, Lt as getStickyFooterScrollbar, N as SegHierarchy, O as NowTimer, P as SimpleScrollGrid, Q as buildEntryKey, R as ViewContainer, Rt as getStickyHeaderDates, Sn as _, Tt as formatIsoTimeString, U as addDurations, Vt as hasBgRendering, Wt as injectStyles, X as asRoughMs, Z as binarySearch, _ as DaySeriesModel, _n as sortEventSegs, at as computeEarliestSegStart, d as BgEvent, et as buildEventRangeKey, f as ContentContainer, g as DayHeader, h as DayCellContainer, ht as diffDays, jt as getEntrySpanEnd, k as PositionCache, ln as rangeContainsMarker, mn as renderScrollShim, n as createPlugin, nn as memoize, nt as buildNavLinkAttrs, p as DateComponent, pn as renderFill, pt as createFormatter, qt as intersectRanges, rn as multiplyDuration, tt as buildIsoString, u as BaseComponent, ut as createDuration, v as DayTableModel, vn as startOfDay, wn as y, xn as wholeDivideDurations, z as ViewContextType } from "./core-CR8mo9oV.js";
import "./internal-B8nNMQvC.js";
import "./preact-B8nNMQvC.js";
import { t as DayTable } from "./internal-C34Y-oRe.js";
...
var TimeCol = class extends BaseComponent {
	...
	renderFillSegs(segs, fillType) {
		let { props, context } = this;
		let children = computeSegVCoords(segs, props.date, props.slatCoords, context.options.eventMinHeight).map((vcoords, i) => {
			let seg = segs[i];
			return y("div", {
