import { $t as isMultiDayRange, Ct as formatDayString, Dt as getDateMeta, Ft as getSegAnchorAttrs, H as addDays, It as getSegMeta, M as Scroller, O as NowTimer, Ot as getDayClassNames, R as ViewContainer, S as EventContainer, Sn as _, Ut as identity, Wt as injectStyles, _n as sortEventSegs, f as ContentContainer, gn as sliceEventStore, n as createPlugin, nn as memoize, nt as buildNavLinkAttrs, p as DateComponent, pt as createFormatter, qt as intersectRanges, rt as buildSegTimeText, u as BaseComponent, vn as startOfDay, wn as y, zt as getUniqueDomId } from "./core-CR8mo9oV.js";
import "./internal-B8nNMQvC.js";
import "./preact-B8nNMQvC.js";
//#region node_modules/@fullcalendar/list/internal.js
var ListViewHeaderRow = class extends BaseComponent {
	constructor() {
		super(...arguments);
		this.state = { textId: getUniqueDomId() };
	}
	render() {
		...
		return y(ContentContainer, {
			...
			elAttrs: { "data-date": formatDayString(dayDate) },
			renderProps,
...
function renderInnerContent(props) {
	...
	}, props.navLinkAttrs), props.text), props.sideText && y("a", Object.assign({
		"aria-hidden": true,
	...
	if (options.displayEventTime !== false) {
		...
		if (doAllDay) {
			...
			return y(ContentContainer, {
				...
				elAttrs: { headers: `${timeHeaderId} ${dateHeaderId}` },
				renderProps,
		...
		return y(NowTimer, { unit: "day" }, (nowDate, todayRange) => {
			...
			for (let dayIndex = 0; dayIndex < segsByDay.length; dayIndex += 1) {
				...
				if (daySegs) {
					...
					for (let seg of daySegs) innerNodes.push(y(ListViewEventRow, Object.assign({
			...
			return y("table", { className: "fc-list-table " + theme.getClass("table") }, y("thead", null, y("tr", null, y("th", {
				scope: "col",
				id: timeHeaderId
