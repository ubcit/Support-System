...
>
    ...
    @if($editable)
        <div class="relative">
            <button
                type="button"
                @click.stop="open = !open; if (open) $nextTick(() => $refs.tagSearch?.focus())"
            ...
            <div
                ...
                x-cloak
                class="absolute left-0 z-50 mt-1 w-56 rounded-xl border border-gray-200 bg-white p-2 shadow-xl dark:border-gray-700 dark:bg-gray-900"
            >
                <input
                    type="text"
                    x-ref="tagSearch"
