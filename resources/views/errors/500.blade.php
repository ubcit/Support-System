...
<head>
    ...
    <title>Server Error | The Space</title>
    <x-common.favicons />
...
<body class="bg-white dark:bg-gray-900">
    <div class="relative flex min-h-screen flex-col items-center justify-center overflow-hidden p-6">
        ...
        <div class="mx-auto w-full max-w-md text-center">
            <p class="text-7xl font-bold text-brand-500">500</p>
            <h1 class="mt-6 text-title-md font-semibold text-gray-800 dark:text-white/90">Something went wrong</h1>
            <p class="mt-3 text-sm text-gray-500 dark:text-gray-400">We encountered an unexpected error. Our team has been notified. Please try again later.</p>
            <a href="{{ url('/') }}"
